...
const LearningGrid = () => {
  return (
    <div className="grid mx-auto grid-cols-1 lg:grid-cols-4 mb-12 max-w-[1200px] w-11/12 pt-20 pb-8">
      {
        LearningGridArray.map((card, index) => {
          return (
            <div
              key={index}
              className={`${index === 0 ? "lg:col-span-2 lg:h-[280px] p-5 bg-transparent" : "h-[280px] p-8"}
            ...
            >
              {
                card.order < 0 ? (
                  <div className="lg:w-[90%] flex flex-col pb-5 gap-3">
                    ...
                    <p className="text-richblack-300 font-medium mt-3 text-sm leading-6">
                      {card.description}
                    </p>
                  ...
                  <div className="flex flex-col gap-6 justify-start">
                    ...
                    <p className="text-richblack-400 text-xs font-normal leading-5">
                      {card.description}
                    </p>
                  </div>
                )
