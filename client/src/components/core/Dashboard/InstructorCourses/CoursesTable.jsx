...
export default function CoursesTable({ courses, setCourses }) {
  ...
  return (
    <div className="w-full">
      {courses?.length === 0 ? (
        <div className="rounded-xl border border-richblack-800 py-10 text-center">
          <p className="text-2xl font-medium text-richblack-100">
            No courses found
          </p>
        </div>
      ) : (
        <div className="overflow-x-auto rounded-xl border border-richblack-800">
            ...
            <tbody>
              {courses.map((course) => (
                ...
                >
                  ...
                  <td className="px-6 py-6">
                    <div className="flex gap-x-4">
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <p className="max-w-[350px] text-xs text-richblack-300">
                  ...
                  {/* Duration */}
                  <td className="px-6 py-6 text-sm font-medium text-richblack-100">
                    2hr 30min
                  </td>
                  ...
                  <td className="px-6 py-6">
                    <div className="flex items-center gap-x-3">
                      ...
                      <button
                        ...
                        title="Edit"
                        className=" text-richblack-100 transition-all duration-200 hover:scale-110 hover:text-caribbeangreen-300"
                      >
                        <FiEdit2 size={20} />
                      </button>
